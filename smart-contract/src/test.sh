...
cast send $CONTRACT_ADDR "createRecordMap(string,string,string)" "a371bc626a53fc7a5d3930ff49d46083e9138ba6e7dfa320b4966682ee1f3b83" "QmeHY3xMtqpvRuGTutrcEToLnPLZxaTBHuJq2K7pUtSVSo" "asf" --private-key $PRIVATE_KEY 
# cast send $CONTRACT_ADDR "createRecordMap(string,string)" "0x333333" "0x444444" --private-key $PRIVATE_KEY
cast call $CONTRACT_ADDR "getAllInfoCurrentMapper()((string,string,string)[])" --private-key $PRIVATE_KEY # use struct member type instead if abi not load 
